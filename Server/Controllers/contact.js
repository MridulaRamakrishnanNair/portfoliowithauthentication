...
function DisplayContactListPage(req, res, next) {
    contact_1.default.find(function (err, contactCollection) {
        ...
        res.render('index', { title: 'Contact List', page: 'contact-list', contact: contactCollection, displayName: Util_1.UserDisplayName, });
    });
}
...
function DisplayEditPage(req, res, next) {
    ...
    contact_1.default.findById(id, {}, {}, (err, contactItemToEdit) => {
        ...
        res.render('index', { title: 'Edit', page: 'update', contact: contactItemToEdit, displayName: Util_1.UserDisplayName, });
    });
}
exports.DisplayEditPage = DisplayEditPage;
function DisplayAddPage(req, res, next) {
    res.render('index', { title: 'Add', page: 'update', contact: "", displayName: Util_1.UserDisplayName, });
}
