...
export function DisplayContactListPage(req: Request, res: Response, next: NextFunction): void
{
    Contact.find(function (err, contactCollection) {
        ...
        res.render('index', {title: 'Contact List', page: 'contact-list', contact: contactCollection, displayName: UserDisplayName,})
    });
}
// Display (E)dit page
export function DisplayEditPage(req: Request, res: Response, next: NextFunction): void
{
    ...
    Contact.findById(id, {}, {}, (err, contactItemToEdit) => {
        ...
        res.render('index', { title: 'Edit', page: 'update', contact: contactItemToEdit, displayName: UserDisplayName,});
    });
}
...
{
    // show the edit view
    res.render('index', { title: 'Add', page: 'update', contact: "" ,displayName: UserDisplayName,});
}
